                        ...
                        <div class="single-left">
                            <div class="flexslider">
                                <ul class="slides">
                                    ...
                                    <li data-thumb="{{ asset('/product/'.$slider->images) }}">
                                        <div class="thumb-image"> <img src="{{ asset('/product/'.$slider->images) }}" data-imagezoom="true" class="img-responsive"> </div>
                                    </li>
                                    @endforeach
                                 </ul>
                            </div>
                        ...
                        <div class="single-right simpleCart_shelfItem">
                            ...
                            <div class="women">
                                ...
                                <form action="{{ url('/add/to/cart') }}" method="post">
                                    ...
                                    <input type="number" name="qty" value="" placeholder="Qty" min="1" />
                                    <div class="women">
